...
const Nav = () => {
  ...
  return (
    <div className="">
      <div className="shadow-sm bg-white rounded-lg w-full">
          ...
          <div className="col-span-2 grid grid-rows-2">
            ...
            <div className="p-3">
              <div className="flex justify-between">
                <Link
                  to="/home"
                  className="font-medium rounded-lg ring-purple-400 lg:w-full hover:ring-2 transition ease-out duration-500"
                >
                  {/* Home Icon */}
                  <svg
